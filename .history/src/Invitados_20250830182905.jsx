...
<div className="panel-lateral">
  ...
  <div className="progreso-item naranja">
    <div className="icono">
      <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="#e67e22" viewBox="0 0 24 24">
  ...
  <div className="progreso-item rojo">
    <div className="icono">
      <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
        ...
        <path d="M15 9L9 15M9 9l6 6" stroke="#c0392b" strokeWidth="2" strokeLinecap="round"/>
      </svg>
    </div>
    <div className="texto">
