      ...
      <div className="contenido">
        ...
        <div className="columna invitados">
          ...
          <ul className="lista-invitados">
            ...
            <li><strong>Familia Rodríguez</strong> (3 personas)</li>
            <li>Carlos Mendez</li>
            <li><strong>Compañeros trabajo</strong> (4 personas)</li>
            <li>Ana Sofi</li>
            <li>Compañeros Padel</li>
            <li><strong>Familia Lara</strong> (7 personas)</li>
          </ul>
          <p className="nota">Arrastra los invitados a las mesas del plano para asignar lugares</p>
        </div>
        ...
        <div className="columna salon">
          ...
          <div className="plano">
            ...
            <div className="mesa ocupada" style={{ top: "60px", right: "200px" }}>
              <span className="mesa-nombre">Mesa 7</span>
              <span className="mesa-info">6/8</span>
            </div>
            <div className="mesa ocupada" style={{ top: "60px", right: "400px" }}>
            ...
            <div className="mesa ocupada" style={{ bottom: "80px", right: "200px" }}>
              <span className="mesa-nombre">Mesa 6</span>
              <span className="mesa-info">8/8</span>
            </div>
            <div className="mesa ocupada" style={{ bottom: "80px", right: "400px" }}>
          ...
          <div className="resumen">
            Asignados: <strong>27/48 invitados</strong> | Mesas ocupadas: <strong>4/6</strong> | Capacidad utilizada: <span className="porcentaje">56%</span>
          </div>
        </div>
      </div>
    </div>
